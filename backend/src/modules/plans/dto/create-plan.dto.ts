import { IsString, IsNumber, IsBoolean, IsOptional, IsEnum, ValidateNested, Min, IsArray } from 'class-validator';
...
class PlanFeaturesDto {
  ...
  @ApiPropertyOptional() @IsBoolean() @IsOptional() multiplePaymentGateways?: boolean;
